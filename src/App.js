...
import VisitedCountries from './Components/CountriesVisited'
...
class App extends Component {
  ...
  addVisitedCountry = id => {
    ...
    const visitCountryList = countriesList.map(eachCountry => {
      if (eachCountry.id === id) {
        return {...eachCountry, isVisited: !eachCountry.isVisited}
      }
      return eachCountry
    })
    this.setState({countriesList: visitCountryList})
  }
